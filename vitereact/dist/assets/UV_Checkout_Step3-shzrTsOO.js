import { g as useParams, h as useNavigate, u as useAppStore, r as reactExports, a as useQuery, j as jsxRuntimeExports, L as Link, I as CircleCheckBig, J as Calendar, K as CreditCard, M as MapPin, i as Package, N as Gift, O as ArrowRight, b as axios } from "./index-CwVo5_So.js";
...
const UV_Checkout_Step3 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-col sm:flex-row gap-4 justify-center items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-lg px-8 py-4 border-2 border-blue-500", children: [
        ...
        order.ticket_number && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-lg px-8 py-4 border-2 border-green-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-1", children: "Ticket Number" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-green-600", children: order.ticket_number })
        ] })
      ] })
    ] }),
