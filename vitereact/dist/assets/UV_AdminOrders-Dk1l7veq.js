import { l as useSearchParams, o as useQueryClient, u as useAppStore, r as reactExports, a as useQuery, j as jsxRuntimeExports, d as CircleAlert, Z as RefreshCw, ai as Download, a5 as Search, ah as Filter, X, i as Package, G as User, c as Mail, P as Phone, M as MapPin, T as Truck, J as Calendar, aj as DollarSign, K as CreditCard, F as FileText, y as Eye, an as RotateCcw, b as axios, D as CircleX, I as CircleCheckBig, C as Clock } from "./index-CwVo5_So.js";
...
const UV_AdminOrders = () => {
  ...
  const isStaff = (currentUser == null ? void 0 : currentUser.user_type) === "staff" || (currentUser == null ? void 0 : currentUser.user_type) === "manager";
  const isAdmin = (currentUser == null ? void 0 : currentUser.user_type) === "admin";
  const assignedLocations = reactExports.useMemo(() => {
    if (currentUser && "assigned_locations" in currentUser && Array.isArray(currentUser.assigned_locations)) {
      return currentUser.assigned_locations;
    }
    return [];
  }, [currentUser]);
  const activeTab = searchParams.get("tab") || "all";
  const statusFilter = searchParams.get("status") || "";
  const locationFilter = isStaff && assignedLocations.length > 0 ? assignedLocations[0] : searchParams.get("location") || "";
  ...
  if (isStaff && assignedLocations.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-md text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-16 h-16 text-yellow-500 mx-auto mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 mb-2", children: "No Location Assigned" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "You are not assigned to a location. Please contact an administrator to be assigned to a location before you can manage orders." })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white shadow-sm border-b border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-gray-600", children: isStaff ? `Manage orders for ${assignedLocations.join(", ")}` : "Manage and track all orders across locations" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6", children: [
        ...
        showFilters && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 border-t border-gray-200 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: [
          ...
          isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          isStaff && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Location" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full px-3 py-2 border border-gray-200 rounded-lg bg-gray-50 text-gray-700", children: assignedLocations.join(", ") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                "select",
                {
                  ...
                  children: [
                    ...
                    isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                        orderDetail.order_status === "payment_confirmed" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "preparing", children: "Start Preparing" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cancelled", children: "Cancel Order" })
                        ] }),
                        orderDetail.order_status === "preparing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ready_for_collection", children: "Ready for Collection" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "out_for_delivery", children: "Out for Delivery" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cancelled", children: "Cancel Order" })
                        ] }),
                        orderDetail.order_status === "ready_for_collection" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "collected", children: "Mark as Collected" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cancelled", children: "Cancel Order" })
                        ] }),
                        orderDetail.order_status === "out_for_delivery" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "delivered", children: "Mark as Delivered" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cancelled", children: "Cancel Order" })
                        ] }),
                        (orderDetail.order_status === "delivered" || orderDetail.order_status === "collected") && /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "completed", children: "Mark as Completed" })
                      ] })
                    )
                  ]
                }
