...
const fetchPrivacyPolicy = async (): Promise<LegalDocument> => {
  const response = await axios.get(
    `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:3000'}/api/legal/privacy`
  );
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="font-sans text-kake-chocolate-500/80">
                  We're unable to load the privacy policy at this time. Please check back later or contact us for more information.
                </p>
              </div>
            </div>
          </div>
