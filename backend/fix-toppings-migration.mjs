...
async function runMigration() {
  ...
  try {
    ...
    console.log('Creating product_toppings table...');
    await client.query(`
    ...
    `);
    console.log('✓ Product_toppings table created');

    console.log('Creating order_item_toppings table...');
    await client.query(`
    ...
    `);
    console.log('✓ Order_item_toppings table created');

    // Create indexes
    console.log('Creating indexes...');
    await client.query('CREATE INDEX IF NOT EXISTS idx_toppings_type ON toppings(topping_type)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_toppings_available ON toppings(is_available)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_product_toppings_product ON product_toppings(product_id)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_product_toppings_topping ON product_toppings(topping_id)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_order_item_toppings_item ON order_item_toppings(item_id)');
    console.log('✓ Indexes created');

    // Insert default toppings
    console.log('Inserting default toppings...');
    await client.query(`
    ...
    `);
    console.log('✓ Default toppings inserted');

    console.log('Inserting default sauces...');
    await client.query(`
      INSERT INTO toppings (topping_id, topping_name, topping_type, price, is_available, display_order) VALUES
      ...
      ON CONFLICT (topping_id) DO NOTHING
    `);
    console.log('✓ Default sauces inserted');
