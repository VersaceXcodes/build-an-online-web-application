import { u as useAppStore, a as useQuery, j as jsxRuntimeExports, m as motion, L as Link, b as axios } from "./index-HeRxKVXe.js";
    ...
    if (location.external_providers) {
      try {
        ...
        if (Array.isArray(parsed)) {
          return parsed.filter((p) => p.is_active && p.name && p.url);
        }
      } catch {
      }
    }
