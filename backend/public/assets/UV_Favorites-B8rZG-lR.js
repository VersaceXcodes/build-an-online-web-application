import { h as useNavigate, o as useQueryClient, u as useAppStore, b as axios, a as useQuery, j as jsxRuntimeExports, H as Heart, L as Link, i as Package, a3 as ShoppingCart } from "./index-i76FChob.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex space-x-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  className: `flex-1 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg transition-colors ${favorite.availability_status === "in_stock" ? "text-white bg-purple-600 hover:bg-purple-700" : "text-gray-400 bg-gray-100 cursor-not-allowed pointer-events-none"}`,
                  children: [
