import { h as useNavigate, u as useAppStore, r as reactExports, R as React, b as axios, j as jsxRuntimeExports } from "./index-HeRxKVXe.js";
...
const UV_Checkout_Step2 = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const errorMessage = ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "Payment processing failed. Please try again.";
      setPaymentError(errorMessage);
      setProcessingPayment(false);
