import { l as useSearchParams, o as useQueryClient, u as useAppStore, r as reactExports, a as useQuery, j as jsxRuntimeExports, ao as reactDomExports, t as Plus, a5 as Search, n as ChevronDown, X, d as CircleAlert, i as Package, ap as Image, I as CircleCheckBig, D as CircleX, V as Star, x as EyeOff, aq as Tag, _ as Pen, a0 as Trash2, ag as Upload, b as axios } from "./index-i76FChob.js";
...
const UV_AdminProducts = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    ...
    productFormModalOpen && reactDomExports.createPortal(
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 bg-white rounded-xl text-left overflow-hidden shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] flex flex-col", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { id: "product-modal-title", className: "text-xl font-semibold text-white", children: productFormMode === "create" ? "Add New Product" : "Edit Product" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: () => setProductFormModalOpen(false),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmitProductForm, className: "px-6 py-6 overflow-y-auto flex-1", children: [
